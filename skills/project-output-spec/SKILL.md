...
2. Read the project brief and the phase template before drafting.
3. Create or revise `docs/project-pipeline/01-output-spec.md` using the exact headings from the template.
4. Define behavior and deliverables without choosing frameworks or implementation details.
